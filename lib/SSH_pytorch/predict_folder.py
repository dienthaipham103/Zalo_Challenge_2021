...
def parser():
    ...
    parser.add_argument('--img', dest='img', default='demo', type=str,
                        help='folder containing images to test')
    parser.add_argument('--img_out', dest='img_out', default='output',
...
if __name__ == '__main__':
    arg = parser()
    input_folder = arg.img
    output_folder = arg.img_out
    visualize = True
    ...
    with torch.no_grad():
        ...
        for filename in os.listdir(input_folder):
            ...
            for i in range(batch_size):
                ...
                if visualize:
                    visusalize_detections(im, cls_dets_single, plt_name=filename[:-4],
                                        visualization_folder=output_folder)
